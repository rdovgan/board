...
public class TestResourcesPool {
	...
	public static final IsCard HEALING_SPELL = new CardTest(99001L, "Spell of Healing", "Restore up to 10 health. Cost: 5 Mana", CardType.Spell,
			new CostBuilder().addCost(Resource.Mana, 5).build(), CardCondition.whenDamaged(), CardEffects.healPlayer(10));

	public static final IsCard HARD_MINING = new CardTest(99002L, "My Friend Vampire",
	...
	public static final IsCardItem IRON_SWORD_CARD = new CardItemTest(99003L, "Old Iron Sword", "Equip one-handed sword with Attack +3", CardType.Item,
